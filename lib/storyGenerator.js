...
DYNAMIC CHARACTER COUNT & GENDER DIVERSITY MANDATE:
...
- GENDER BALANCE: You MUST include a balanced mix of BOTH male AND female characters in every scenario (e.g. include female portraits like "lyra", "elena", "vera", or "astra" AND male portraits like "corwin", "garrow", "sable", "scholar", etc.). NEVER generate a scenario containing only one gender!
...
5. "characters": Array of 2 to 7 character objects with alternating/balanced male and female characters. Each must have:
